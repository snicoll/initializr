...
/**
 * Integration tests for a custom {@link ProjectGenerationController} that maps to a
 * custom request.
 *
...
public class ProjectGenerationControllerCustomRequestIntegrationTests
	...
	static class CustomProjectRequestToDescriptionConverter extends DefaultProjectRequestToDescriptionConverter {
		...
		public ProjectDescription convert(ProjectRequest request, InitializrMetadata metadata) {
			...
			description.setCustomFlag(((CustomProjectRequest) request).isCustomFlag());
