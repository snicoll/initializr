...
class InitializrMetadataBuilder {
	...
	private InitializrMetadataBuilder() {}

	/**
	 * Create a builder instance from the specified {@link InitializrProperties}. Initialize
	 * the configuration to use.
	 * @see #withInitializrConfiguration(io.spring.initializr.InitializrConfiguration)
	 * @see #withInitializrProperties(io.spring.initializr.metadata.InitializrProperties)
	 */
	public static InitializrMetadataBuilder fromInitializrProperties(InitializrProperties configuration) {
		new InitializrMetadataBuilder().withInitializrConfiguration(configuration).withInitializrProperties(configuration)
	}
	...
	public static InitializrMetadataBuilder create() {
		new InitializrMetadataBuilder().withInitializrConfiguration(new InitializrConfiguration())
	}

	/**
	 * Replace the {@link InitializrConfiguration} with the specified one.
	 */
	InitializrMetadataBuilder withInitializrConfiguration(InitializrConfiguration configuration) {
